...
export function DatenschutzComponent() {
  return (
    <div className="Datenschutz">
      <aside className="Datenschutz__back">
      ...
      <p>
        ...
        Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff
      ...
      <p>
        ...
        erforderlich ist, wenn wir gesetzlich hierzu verpflichtet sind (z. B. Weitergabe von Datenan Steuerbehörden),
